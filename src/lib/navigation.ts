...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: '/dashboard/technician/inventory', label: 'My Inventory', icon: 'I' },
  ...
  { href: '/dashboard/claims', label: 'Claims & Requests', icon: 'C' },
  { href: '/dashboard/claims/approvals', label: 'Claim Approvals', icon: 'A' },
  { href: '/dashboard/claims/disbursements', label: 'Disbursements', icon: 'D' },

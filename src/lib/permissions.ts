...
export const PERMISSIONS: Record<UserRole, RolePermission> = {
  ...
  boss: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/boss', '/dashboard/leave', '/dashboard/attendance', '/dashboard/procurement-approvals', '/dashboard/notifications', '/dashboard/profile', '/dashboard/settings', '/dashboard/users'],
  ...
  technician: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/technician', '/dashboard/leave', '/dashboard/attendance', '/dashboard/notifications', '/dashboard/profile', '/dashboard/settings'],
  ...
  courier: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/courier', '/dashboard/leave', '/dashboard/attendance', '/dashboard/notifications', '/dashboard/profile', '/dashboard/settings'],
  ...
  admin: {
    routes: ['/dashboard', '/dashboard/admin', '/dashboard/client/products', '/dashboard/marketing/clients', '/dashboard/warehouse/catalog', '/dashboard/notifications', '/dashboard/profile', '/dashboard/settings', '/dashboard/users'],
  ...
  director: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/director', '/dashboard/leave', '/dashboard/attendance', '/dashboard/notifications', '/dashboard/profile', '/dashboard/settings', '/dashboard/users'],
  ...
  tax: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/tax', '/dashboard/leave', '/dashboard/attendance', '/dashboard/notifications', '/dashboard/profile', '/dashboard/settings'],
  ...
  faktur: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/faktur', '/dashboard/leave', '/dashboard/attendance', '/dashboard/notifications', '/dashboard/profile', '/dashboard/settings'],
  ...
  manager: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/approvals', '/dashboard/leave', '/dashboard/attendance', '/dashboard/notifications', '/dashboard/profile', '/dashboard/settings', '/dashboard/users'],
  ...
  purchasing: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/purchasing', '/dashboard/approvals', '/dashboard/leave', '/dashboard/attendance', '/dashboard/notifications', '/dashboard/profile', '/dashboard/settings'],
    readableEntities: ['profiles:self', 'products:all', 'inventory_logs:all', 'chat:staff'],
    writableEntities: ['notifications:own'],
  },
  claim_officer: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/claims', '/dashboard/approvals', '/dashboard/leave', '/dashboard/attendance', '/dashboard/notifications', '/dashboard/profile', '/dashboard/settings'],

...
export const PERMISSIONS: Record<UserRole, RolePermission> = {
  client: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/client', '/dashboard/client/setup', '/dashboard/client/issues', '/dashboard/client/products', '/dashboard/client/equipment', '/dashboard/notifications', '/request'],
  ...
  marketing: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/marketing', '/dashboard/marketing/clients', '/dashboard/marketing/prices', '/dashboard/notifications'],
  ...
  boss: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/boss', '/dashboard/notifications'],
  ...
  technician: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/technician', '/dashboard/notifications'],
  ...
  courier: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/courier', '/dashboard/notifications'],
  ...
  director: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/director', '/dashboard/notifications'],
    readableEntities: ['profiles:all', 'products:all', 'price_list:all', 'requests:all', 'invoices:reporting', 'faktur_tasks:all', 'inventory_logs:all', 'delivery_logs:all', 'issues:admin', 'notifications:own', 'activity_logs:all', 'monthly_closing:owner', 'chat:staff'],
    writableEntities: ['notifications:own'],
  },
  tax: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/tax', '/dashboard/notifications'],

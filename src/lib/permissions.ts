...
export const PERMISSIONS: Record<UserRole, RolePermission> = {
  client: {
    routes: ['/dashboard', '/dashboard/client', '/dashboard/client/issues', '/dashboard/client/products', '/dashboard/client/equipment', '/dashboard/notifications', '/dashboard/profile', '/request'],
  ...
  marketing: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/marketing', '/dashboard/marketing/clients', '/dashboard/marketing/prices', '/dashboard/leave', '/dashboard/attendance', '/dashboard/procurement-approvals', '/dashboard/notifications', '/dashboard/profile'],
  ...
  boss: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/boss', '/dashboard/leave', '/dashboard/attendance', '/dashboard/procurement-approvals', '/dashboard/notifications', '/dashboard/profile'],
  ...
  finance: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/finance', '/dashboard/claims', '/dashboard/approvals', '/dashboard/leave', '/dashboard/attendance', '/dashboard/notifications', '/dashboard/profile'],
  ...
  warehouse: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/warehouse', '/dashboard/warehouse/inventory', '/dashboard/warehouse/catalog', '/dashboard/warehouse/request-purchase', '/dashboard/stock', '/dashboard/purchasing', '/dashboard/leave', '/dashboard/attendance', '/dashboard/notifications', '/dashboard/profile'],
  ...
  technician: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/technician', '/dashboard/leave', '/dashboard/attendance', '/dashboard/notifications', '/dashboard/profile'],
  ...
  courier: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/courier', '/dashboard/leave', '/dashboard/attendance', '/dashboard/notifications', '/dashboard/profile'],
  ...
  admin: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/admin', '/dashboard/cms', '/dashboard/approvals', '/dashboard/purchasing', '/dashboard/claims', '/dashboard/stock', '/dashboard/warehouse/request-purchase', '/dashboard/leave', '/dashboard/attendance', '/dashboard/procurement-approvals', '/dashboard/notifications', '/dashboard/profile'],
  ...
  owner: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/owner', '/dashboard/owner/reports', '/dashboard/cms', '/dashboard/approvals', '/dashboard/purchasing', '/dashboard/claims', '/dashboard/stock', '/dashboard/warehouse/request-purchase', '/dashboard/leave', '/dashboard/attendance', '/dashboard/procurement-approvals', '/dashboard/notifications', '/dashboard/profile'],
  ...
  director: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/director', '/dashboard/leave', '/dashboard/attendance', '/dashboard/notifications', '/dashboard/profile'],
    readableEntities: ['profiles:all', 'products:all', 'price_list:all', 'requests:all', 'invoices:reporting', 'faktur_tasks:all', 'inventory_logs:all', 'delivery_logs:all', 'issues:admin', 'notifications:own', 'activity_logs:all', 'monthly_closing:owner', 'chat:staff', 'leave_requests:all'],
    writableEntities: ['notifications:own', 'leave_requests:all'],
  },
  tax: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/tax', '/dashboard/leave', '/dashboard/attendance', '/dashboard/notifications', '/dashboard/profile'],
  ...
  faktur: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/faktur', '/dashboard/leave', '/dashboard/attendance', '/dashboard/notifications', '/dashboard/profile'],
  ...
  manager: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/approvals', '/dashboard/leave', '/dashboard/attendance', '/dashboard/notifications', '/dashboard/profile'],
  ...
  purchasing: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/purchasing', '/dashboard/approvals', '/dashboard/leave', '/dashboard/attendance', '/dashboard/notifications', '/dashboard/profile'],
    readableEntities: ['profiles:self', 'products:all', 'inventory_logs:all', 'chat:staff'],
    writableEntities: ['notifications:own'],
  },
  claim_officer: {
    routes: ['/dashboard', '/dashboard/company', '/dashboard/claims', '/dashboard/approvals', '/dashboard/leave', '/dashboard/attendance', '/dashboard/notifications', '/dashboard/profile'],

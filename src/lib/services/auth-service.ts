...
const ROLE_REDIRECTS: Record<UserRole, string> = {
  ...
  director: '/dashboard/director-overview',
  finance: '/dashboard/finance',
  warehouse: '/dashboard/warehouse',
  technician: '/dashboard/delivery',
  courier: '/dashboard/courier-portal',
  admin: '/dashboard/admin-panel',
  owner: '/dashboard/owner',
  tax: '/dashboard/tax-reports',
  faktur: '/dashboard/faktur-tasks',
